      ...
      if (0 !== t(this).length) {
        ...
        var l = {
            ...
            var o = {
              ...
              paginationUpdate: function () {
                ...
                t(n).each(function (e, a) {
                  ...
                  1 === o.meta.page
                    ? (t(r).attr('disabled', !0).addClass('kt-datatable__pager-link--disabled'),
                      t(s).attr('disabled', !0).addClass('kt-datatable__pager-link--disabled'))
                    : (t(r).removeAttr('disabled').removeClass('kt-datatable__pager-link--disabled'),
                      t(s).removeAttr('disabled').removeClass('kt-datatable__pager-link--disabled')),
                  o.meta.page === o.meta.pages
                    ? (t(d).attr('disabled', !0).addClass('kt-datatable__pager-link--disabled'),
                      t(c).attr('disabled', !0).addClass('kt-datatable__pager-link--disabled'))
                    : (t(d).removeAttr('disabled').removeClass('kt-datatable__pager-link--disabled'),
              ...
              var a = function (a) {
                  ...
                  0 === t(r).length &&
                    ((r = t('<tr/>')
                      ...
                      .hide()
                      .append(t('<td/>').addClass('kt-datatable__subtable').attr('colspan', l.getTotalColumns()))),
                    t(n).after(r),
            ...
            var e = {
              ...
              sortClick: function (n) {
                ...
                if (
                  ...
                  (t(i.tableHead).find('th').removeClass('kt-datatable__cell--sorted'),
          ...
          rows: function (e) {
            return (
              l.isLocked()
                ? (l.nodeTr = l.recentNode = t(i.tableBody).find(e).filter('.kt-datatable__lock--scroll > .kt-datatable__row'))
                : (l.nodeTr = l.recentNode = t(i.tableBody).find(e).filter('.kt-datatable__row')),
              i
            );
          },
          column: function (e) {
          ...
          columns: function (e) {
            ...
            return (
              n.length > 0 ? (l.nodeCols = l.recentNode = n) : (l.nodeCols = l.recentNode = t(a).find(e).filter('.kt-datatable__cell')), i
            );
          },
          cell: function (e) {
                ...
                .click(function (o) {
                  ...
                  t(this).is(':checked')
                    ...
                    !a.vars.requestIds &&
                      ...
                      t(e.tableHead).find('.kt-checkbox--all > [type="checkbox"]').prop('checked', !1);
                  var l = {};
